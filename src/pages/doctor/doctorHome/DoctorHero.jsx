...
function DoctorHero() {
    ...
    const doctorImages = [
        'https://images.unsplash.com/photo-1612349317150-e413f6a5b16d?w=500&auto=format',
        'https://images.unsplash.com/photo-1537368910025-700350fe46c7?w-500&auto=format',
        'https://images.unsplash.com/photo-1551601651-2a8555f1a136?w=500&auto=format',
        'https://images.unsplash.com/photo-1582750433449-648ed127bb54?w=500&auto=format',
    ];
    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-blue-50 to-cyan-50 flex items-center justify-center px-4 md:px-8 lg:px-16 ">
                ...
                >
                    ...
                    <div className="flex flex-wrap gap-4 pt-4">
                        <motion.button
                            ...
                            whileTap={{ scale: 0.95 }}
                            className="px-8 py-3 bg-gradient-to-r from-blue-600 to-cyan-500 text-white rounded-full font-semibold shadow-lg hover:shadow-xl transition-shadow duration-300"
                        >
                        ...
                        <motion.button
                            whileHover={{ scale: 1.05 }}
                            whileTap={{ scale: 0.95 }}
                            className="px-8 py-3 border-2 border-blue-500 text-blue-600 rounded-full font-semibold hover:bg-blue-50 transition-colors duration-300"
                        >
                            Meet Our Doctors
                        </motion.button>
                    </div>

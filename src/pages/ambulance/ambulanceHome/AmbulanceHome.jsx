    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-gray-50 to-blue-50 p-6">
            <div className='container mx-auto '>
                ...
                {/* Coming Soon Banner */}
                <div className="px-4 mx-auto mb-12">
                    <div className="bg-gradient-to-r from-yellow-400 to-orange-500 rounded-2xl p-8 text-white text-center shadow-2xl transform  transition-transform duration-300 animate-pulse-slow">
                        <div className="flex items-center justify-center mb-4">
                            <FaRocket className="text-2xl mr-3 animate-bounce text-red-400" />
                            <h2 className="text-3xl font-bold text-red-500">Coming Soon.....</h2>
                        </div>
